...
int main() {
    printf(CHALK_BG_LIGHT_RED_F("%d x %d = %d"), 2, 3, 6);
    return 0;
    const char *hello_chalk[] = {
        chalkf(CHALK_BG_LIGHT_BLUE, "H"),
        chalkf(CHALK_BG_LIGHT_CYAN, "E"),
        chalkf(CHALK_BG_LIGHT_GREEN, "L"),
        chalkf(CHALK_BG_LIGHt_MAGENTA, "L"),
        chalkf(CHALK_BG_LIGHT_RED, "O"),
        chalkf(CHALK_BG_LIGHT_WHITE, " "),
        chalkf(CHALK_BG_LIGHT_YELLOW, chalkf(CHALK_BLACK, "C")),
        chalkf(CHALK_BG_MAGENTA, "H"),
        chalkf(CHALK_BG_BLACK, "A"),
        chalkf(CHALK_BG_RED, "L"),
        chalkf(CHALK_BG_LIGHT_WHITE, chalkf(CHALK_BLACK, "K")),
    };
